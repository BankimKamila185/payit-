    ...
    <div className="phone-container">
      ...
      <div className="payit-navbar-container">
        ...
        >
          ...
          {/* 3. QR Scanner / Keypad Tab */}
          <div className="nav-item-wrapper">
            <button 
              onClick={() => onScreenChange('transfer')} 
              className={`nav-circle-btn ${['transfer', 'qr-scanner'].includes(currentScreen) ? 'active scanner-active' : ''}`}
              aria-label="Scan & Transfer"
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                <path d="M6 9 V6 H9" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M15 6 H18 V9" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M6 15 V18 H9" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M15 18 H18 V15" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
                <line className="anim-scanner-laser" x1="8" y1="12" x2="16" y2="12" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" />
              </svg>
            </button>
          </div>
          ...
          <div className="nav-item-wrapper">
            <button 
              ...
              aria-label="Payit Shield"
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                <path className="anim-shield-main" d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
              </svg>
            </button>
          </div>
